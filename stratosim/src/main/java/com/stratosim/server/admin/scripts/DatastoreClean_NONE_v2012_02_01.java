...
public class DatastoreClean_NONE_v2012_02_01 extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    out.println("<html>"
          + "<head><title>Admin - clean NONE v2012_02_01</title></head>"
          + "<body>"
  ...
  private static boolean cleanEntity(Entity entity) {
    ...
    for (Map.Entry<String, Object> entry : entity.getProperties().entrySet()) {
      FileRole role = FileRole.valueOf(entry.getValue().toString());
